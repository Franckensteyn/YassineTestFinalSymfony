...
-- -----------------------------------------------------
-- Schema yassinetestfinal
-- -----------------------------------------------------

-- -----------------------------------------------------
-- Schema yassinetestfinal
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `yassinetestfinal` DEFAULT CHARACTER SET latin1 ;
USE `yassinetestfinal` ;

-- -----------------------------------------------------
-- Table `yassinetestfinal`.`fos_user`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `yassinetestfinal`.`fos_user` (
...
-- -----------------------------------------------------
-- Table `yassinetestfinal`.`article`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `yassinetestfinal`.`article` (
  ...
  CONSTRAINT `fk_article_fos_user`
    ...
    REFERENCES `yassinetestfinal`.`fos_user` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `yassinetestfinal`.`section`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `yassinetestfinal`.`section` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `yassinetestfinal`.`section_has_article`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `yassinetestfinal`.`section_has_article` (
  ...
  CONSTRAINT `fk_section_has_article_section1`
    ...
    REFERENCES `yassinetestfinal`.`section` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_section_has_article_article1`
    FOREIGN KEY (`article_id`)
    REFERENCES `yassinetestfinal`.`article` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
